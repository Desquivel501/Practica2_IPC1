 ...
 * @author Derek
 */
public class reportePokemonSalvaje {
    
    public void  reportePokemon(String[] pokemonSalvaje,int largo) throws IOException{
        Controller controller = new Controller();
        escritor escritor = new escritor();
        Random rand = new Random();
        File file = new File("Reportes\\ReportePokemon\\Home.html");
        ...
        html= "<!DOCTYPE html>\n" +
                ...
                "        <h1 class=\"u-text u-text-1\">Lista de Pokemon Salvajes</h1>\n" +
                "      </div>\n" +
                "    </section>\n" +
                ...
                for (int i = 0; i < largo; i++) {
                    String imageName = pokemonSalvaje[i].toLowerCase();
                    ...
                    html+=  "          <div class=\"u-border-2 u-border-grey-75 u-container-style u-list-item u-repeater-item\">\n" +
                            ...
                            "              <h2 class=\"u-text u-text-1\">" + pokemonSalvaje[i] + "</h2>\n" +
                            "            </div>\n" +
                            "          </div>\n";
                }
        ...
        html += "        </div>\n" +
         ...
         escritor.escribirReporte(html, "Reportes\\ReportePokemon\\Home.html");
