 ...
 * @author Derek
 */
public class reporteTopAlimento {
    public void reporteTopAlimento(String[] alimento) throws IOException{
        Random rand = new Random();
        escritor escritor = new escritor();
        File file = new File("Reportes\\ReporteTopAlimentos\\Home.html");
        String html;
        ...
        html=   "<!DOCTYPE html>\n" +
                ...
                "        <h1 class=\"u-text u-text-1\">Top 5 Alimentos</h1>\n" +
                "      </div>\n" +
                "    </section>\n" +
                ...
                for (int i = 0; i < alimento.length; i++) {
                    ...
                    html += "          <div class=\"u-border-2 u-border-grey-75 u-container-style u-list-item u-repeater-item\">\n" +
                            "            <div class=\"u-container-layout u-similar-container u-container-layout-1\"><span class=\"u-file-icon u-icon u-icon-rectangle u-text-palette-1-base u-icon-1\"><img src=\"images/"+imagenComida+".png\" alt=\"\"></span>\n" +
                            "              <h2 class=\"u-text u-text-1\">" + alimento[i] +"</h2>\n" +
        ...
        escritor.escribirReporte(html, "Reportes\\ReporteTopAlimentos\\Home.html");
